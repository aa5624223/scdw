...
namespace OA_WX_GPS.Entity
{
    ...
    public class uf_CarGPS_WFRoute : ActiveRecordBase
    {
        ...
        /// <summary>
        /// "SELECT NEW uf_CarGPS_WFRoute(a.id,a.PointsCount,a.CreateTime,a.RouteRange,a.WFRangeID,a.Points,a.LastUpdateTime) FROM uf_CarGPS_WFRoute
        /// </summary>
        /// <param name="id"></param>
        /// <param name="PointsCount"></param>
        /// <param name="CreateTime"></param>
        /// <param name="RouteRange"></param>
        /// <param name="WFRangeID"></param>
        /// <param name="Points"></param>
        /// <param name="LastUpdateTime"></param>
        public uf_CarGPS_WFRoute(int id, int PointsCount, string CreateTime, decimal RouteRange, int WFRangeID, string Points,string LastUpdateTime)
        {
            this.id = id;
            this.PointsCount = PointsCount;
            this.CreateTime = CreateTime;
