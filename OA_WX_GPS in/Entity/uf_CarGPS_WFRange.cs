...
namespace OA_WX_GPS.Entity
{
    ...
    public class uf_CarGPS_WFRange : ActiveRecordBase
    {
        ...
        /// <param name="ccqsrq"></param>
        /// <param name="ccqssj"></param>
        /// <param name="ccjzrq"></param>
        /// <param name="ccjzsj"></param>
        /// <param name="ccdd"></param>
        /// <param name="Range"></param>
        /// <param name="RangeCount"></param>
        /// <param name="sqgs"></param>
        /// <param name="sqbm"></param>
        ...
        public uf_CarGPS_WFRange(int id, int wfRequestId, int sqr, string ccqsrq, string ccqssj, string ccjzrq, string ccjzsj, string ccdd, decimal Range, int RangeCount, int sqgs, int sqbm,string LastUpdateTime)
        {
            this.id = id;
            this.wfRequestId = wfRequestId;
            this.sqr = sqr;
        ...
        public uf_CarGPS_WFRange(int id, int wfRequestId, int sqr, string ccqsrq, string ccqssj, string ccjzrq, string ccjzsj, string ccdd, decimal Range, int RangeCount, int sqgs, int sqbm, string LastUpdateTime,string WxOpenid)
        {
            this.id = id;
            this.wfRequestId = wfRequestId;
            this.sqr = sqr;
