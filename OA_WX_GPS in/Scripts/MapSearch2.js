...
function init(la,lo,pcs) {
    ...
    if (isGps == false) {
        var pot = [];
        pot.push(paths[0][0][0]);
        pot.push(paths[0][0][1]);
        ...
        pot = [];
        //paths[paths.length - 1][paths[paths.length - 1].length - 1]
        pot.push(paths[paths.length - 1][paths[paths.length - 1].length - 1][0]);
        pot.push(paths[paths.length - 1][paths[paths.length - 1].length - 1][1]);
